...
//!
//! This wraps the FFI bindings provided by `fd_env_sys` and provides
...
pub mod cmdline {
    ...
    impl CommandLine {
        ...
        pub fn strip_ulong(&mut self, key: &str, env_key: Option<&str>, default: u64) -> u64 {
            ...
            unsafe {
                fd_env_sys::fd_env_strip_cmdline_ulong(
                    &mut self.argc,
        ...
        pub fn strip_uint(&mut self, key: &str, env_key: Option<&str>, default: u32) -> u32 {
            ...
            unsafe {
                fd_env_sys::fd_env_strip_cmdline_uint(
                    &mut self.argc,
                    &mut self.argv.as_mut_ptr(),
                    c_key.as_ptr(),
                    env_key_ptr,
        ...
        pub fn strip_int(&mut self, key: &str, env_key: Option<&str>, default: i32) -> i32 {
            ...
            unsafe {
                fd_env_sys::fd_env_strip_cmdline_int(
                    &mut self.argc,
                    &mut self.argv.as_mut_ptr(),
                    c_key.as_ptr(),
                    env_key_ptr,
        ...
        pub fn strip_long(&mut self, key: &str, env_key: Option<&str>, default: i64) -> i64 {
            ...
            unsafe {
                fd_env_sys::fd_env_strip_cmdline_long(
                    &mut self.argc,
                    &mut self.argv.as_mut_ptr(),
                    c_key.as_ptr(),
                    env_key_ptr,
        ...
        pub fn strip_cstr(&mut self, key: &str, env_key: Option<&str>, default: &str) -> String {
            ...
            unsafe {
                let result = fd_env_sys::fd_env_strip_cmdline_cstr(
                    &mut self.argc,
                    &mut self.argv.as_mut_ptr(),
                    c_key.as_ptr(),
                    env_key_ptr,
        ...
        pub fn strip_float(&mut self, key: &str, env_key: Option<&str>, default: f32) -> f32 {
            ...
            unsafe {
                fd_env_sys::fd_env_strip_cmdline_float(
                    &mut self.argc,
                    &mut self.argv.as_mut_ptr(),
                    c_key.as_ptr(),
                    env_key_ptr,
        ...
        pub fn contains_and_strip(&mut self, key: &str) -> bool {
            ...
            unsafe {
                fd_env_sys::fd_env_strip_cmdline_contains(
                    &mut self.argc,
                    &mut self.argv.as_mut_ptr(),
                    c_key.as_ptr(),
                ) != 0
