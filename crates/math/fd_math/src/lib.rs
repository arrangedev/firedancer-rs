...
pub mod stat {
    ...
    pub fn filter_uint(values: &[u32], threshold: u32) -> Vec<u32> {
        ...
        let count = unsafe {
            libfd_math_sys::fd_stat_filter_uint(
                output.as_mut_ptr(),
                values.as_ptr(),
                values.len() as u64,
                threshold,
    ...
    pub fn filter_ulong(values: &[u64], threshold: u64) -> Vec<u64> {
        ...
        let count = unsafe {
            libfd_math_sys::fd_stat_filter_ulong(
                output.as_mut_ptr(),
                values.as_ptr(),
                values.len() as u64,
                threshold,
    ...
    pub fn filter_float(values: &[f32], threshold: f32) -> Vec<f32> {
        ...
        let count = unsafe {
            libfd_math_sys::fd_stat_filter_float(
                output.as_mut_ptr(),
                values.as_ptr(),
                values.len() as u64,
                threshold,
    ...
    pub fn median_uint(values: &mut [u32]) -> Option<u32> {
        ...
        let result = unsafe {
            libfd_math_sys::fd_stat_median_uint(values.as_mut_ptr(), values.len() as u64)
        };
        Some(result)
    }
    ...
    pub fn median_ulong(values: &mut [u64]) -> Option<u64> {
        ...
        let result = unsafe {
            libfd_math_sys::fd_stat_median_ulong(values.as_mut_ptr(), values.len() as u64)
        };
        Some(result)
    }
    ...
    pub fn median_float(values: &mut [f32]) -> Option<f32> {
        ...
        let result = unsafe {
            libfd_math_sys::fd_stat_median_float(values.as_mut_ptr(), values.len() as u64)
        };
        Some(result)
    }
